...
import com.example.smshunter.LogStorage
import com.example.smshunter.NotificationHelper
import com.example.smshunter.ScanLog
        ...
        if (intent.action == Telephony.Sms.Intents.SMS_RECEIVED_ACTION) {
            ...
            for (sms in msgs) {
                ...
                SpamDetector.checkMessage(body) { verdict, reasons ->
                    LogStorage.logList.add(0, ScanLog(sender, body, verdict))
